                                    ...
                                    <div style="flex: 1;">
                                        ...
                                        <div style="margin-bottom: 16px;">
                                            ...
                                            <div style="display: flex; flex-direction: column; gap: 8px;">
                                                <label
                                                    style="display: flex; align-items: center; gap: 8px; cursor: pointer; font-size: 14px;">
                                                    <input type="checkbox" id="edit-tunai" name="tunai" value="1"
                                                        style="width: 16px; height: 16px; accent-color: #6C4F51;">
                                                    <span>Tunai</span>
                                                </label>
                                                <label
                                    ...
                                    <div style="flex: 1;">
                                        <div style="margin-bottom: 16px;">
                                            <label for="edit-lbangunan"
                                                style="display: block; margin-bottom: 6px; font-weight: 500; color: #333;">Luas
                                                Bangunan (m²)</label>
                                            <input type="number" id="edit-lbangunan" name="lbangunan" step="0.01"
                                                style="width: 100%; padding: 8px 12px; border: 1px solid #ced4da; border-radius: 4px; font-size: 14px;">
                                        </div>
                                        ...
                                        <div style="margin-bottom: 16px;">
                                            ...
                                            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 8px;">
                                                <label
                                                    style="display: flex; align-items: center; gap: 8px; cursor: pointer; font-size: 14px;">
                                                    <input type="checkbox" id="edit-ac" name="ac" value="1"
                                                        style="width: 16px; height: 16px; accent-color: #6C4F51;">
                                                    <span>AC</span>
                                                </label>
                                                <label
                                                    style="display: flex; align-items: center; gap: 8px; cursor: pointer; font-size: 14px;">
                                                    <input type="checkbox" id="edit-kasur" name="kasur" value="1"
                                                        style="width: 16px; height: 16px; accent-color: #6C4F51;">
                                                    <span>Kasur</span>
                                                </label>
                                                <label
                                                ...
                                                <label
                                                    style="display: flex; align-items: center; gap: 8px; cursor: pointer; font-size: 14px;">
                                                    <input type="checkbox" id="edit-wifi" name="wifi" value="1"
                                                        style="width: 16px; height: 16px; accent-color: #6C4F51;">
                                                    <span>WiFi</span>
                                                </label>
                                                <label
                                                    style="display: flex; align-items: center; gap: 8px; cursor: pointer; font-size: 14px;">
                                                    <input type="checkbox" id="edit-dapur" name="dapur" value="1"
                                                        style="width: 16px; height: 16px; accent-color: #6C4F51;">
                                                    <span>Dapur</span>
                                                </label>
                                                <label
                                        ...
                                        <div style="margin-bottom: 16px;">
                                            ...
                                            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 8px;">
                                                ...
                                                <label
                                                    style="display: flex; align-items: center; gap: 8px; cursor: pointer; font-size: 14px;">
                                                    <input type="checkbox" id="edit-cctv" name="cctv" value="1"
                                                        style="width: 16px; height: 16px; accent-color: #6C4F51;">
                                                    <span>CCTV</span>
                                                </label>
                                                <label
                                        ...
                                        <div style="margin-bottom: 16px;">
                                            ...
                                            <div style="display: flex; gap: 20px;">
                                                ...
                                                <label
                                                    style="display: flex; align-items: center; gap: 8px; cursor: pointer; font-size: 14px;">
                                                    <input type="checkbox" id="edit-air" name="air" value="Ada"
                                                        style="width: 16px; height: 16px; accent-color: #6C4F51;">
                                                    <span>Air</span>
                                                </label>
                                            </div>
    ...
    <script>
        ...
        function addKosPoints(data) {
            ...
            data.features.forEach((feature) => {
                ...
                const isAdmin = currentUser === 'adminkostfinder@gmail.com';
                const isOwner = feature.properties.user_email === currentUser;
                ...
                ${fotoUrl ? `<img src="${fotoUrl}" style="max-width: 100%; height: auto; margin-top: 10px; border-radius: 4px;">` : ''}
        ...
        async function deletePoint(pointId) {
            if (!confirm('Serius nih mau di hapus?')) return;
